...
from minigpt4.datasets.datasets.coco_caption import RefCOCOEvalData, RefCOCOEvalDataText, RefCOCOEvalDataTargetText
...
data = RefCOCOEvalDataTargetText(refcoco, vis_processor, img_path)
