...
class RefCOCOEvalDataText(torch.utils.data.Dataset):
    def __init__(self, loaded_data, vis_processor, root_path):
        self.loaded_data = loaded_data
        self.root_path = root_path
        self.vis_processor = vis_processor
    ...
    def __getitem__(self, idx):
        ...
        image_orig_size = (data["width"], data["height"])
        ...
        return image, question, img_id, answer


class RefCOCOEvalDataTargetText(torch.utils.data.Dataset):
    def __init__(self, loaded_data, vis_processor, root_path):
        self.loaded_data = loaded_data
        self.root_path = root_path
        self.vis_processor = vis_processor
...
class RefCOCOEvalDataTextwithPIL(torch.utils.data.Dataset):
    def __init__(self, loaded_data, root_path):
        self.loaded_data = loaded_data
        self.root_path = root_path
...
class RefCOCOEvalDataTargetTextwithPIL(torch.utils.data.Dataset):
    def __init__(self, loaded_data, root_path):
        self.loaded_data = loaded_data
        self.root_path = root_path
